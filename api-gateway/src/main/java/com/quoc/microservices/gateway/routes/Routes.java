...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceSwaggerRoute() {
        return route("product_service_swagger")
                .route(RequestPredicates.path("/aggregate/products-service/v3/api-docs"), HandlerFunctions.http(productServiceUrl))
    ...
    public RouterFunction<ServerResponse> orderServiceSwaggerRoute() {
        return route("orders_service_swagger")
                .route(RequestPredicates.path("/aggregate/orders-service/v3/api-docs"), HandlerFunctions.http(orderServiceUrl))
